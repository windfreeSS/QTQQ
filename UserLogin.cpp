...
bool UserLogin::veryfyAccountCode()//验证账户&密码
{//需优化
...
void UserLogin::onLoginBtnClicked() {
	if (!veryfyAccountCode()) {
		QMessageBox::warning(NULL, QString::fromLocal8Bit("提示"), QString::fromLocal8Bit("您输入的账号或密码请重新输入!"));
